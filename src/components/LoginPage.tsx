              ...
              {screen === "signin" && (
                ...
                >
                  <div className="flex-1 flex flex-col">
                    ...
                    {/* Social Logins */}
                    <div className="flex gap-3 mt-4 max-w-sm mx-auto w-full">
                      <button
                        onClick={handleVerifyConfirm}
                        className="flex-1 flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-900 text-white font-extrabold text-xs py-3.5 px-3 rounded-full uppercase tracking-wider active:scale-95 transition-all shadow-sm cursor-pointer"
                      >
                      ...
                      <button
                        onClick={handleVerifyConfirm}
                        className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-300 text-zinc-700 font-extrabold text-xs py-3.5 px-3 rounded-full uppercase tracking-wider active:scale-95 transition-all shadow-sm hover:bg-gray-50 cursor-pointer"
                      >
                    ...
                    {/* Divider */}
                    <div className="flex items-center my-3.5 max-w-sm mx-auto w-full">
                    ...
                    <form onSubmit={handleSignIn} className="flex flex-col gap-3.5 max-w-sm mx-auto w-full">
                      ...
                      <button
                        ...
                        className="w-full bg-brand hover:bg-brand-dark text-white font-extrabold text-sm py-4 px-6 rounded-full uppercase tracking-widest active:scale-95 transition-all shadow-md shadow-brand/10 mt-1 h-13.5 flex items-center justify-center cursor-pointer"
                      >
                        {loading ? (
